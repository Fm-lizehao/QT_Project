...
GamePage::GamePage(QString bg, QRect bgArea, MainWindow *parent, int wid, int heig)
...
GamePage::~GamePage() { delete player; }
    ...
    : GamePage(pic(Startup_leftCastle), QRect(80, 120, 1100, 600), parent, wid, heig)
{
    ...
    virtualObjects.insert(std::make_pair("001:Cloud", new VirtualObject(this, pic(Cloud_0_cute), 200, 40, -1, 0, 0, 0, this->width(), 0, this->height(), false)));
    ...
    virtualObjects.insert(std::make_pair("005:Jp-of", new VirtualObject(this, pic(Startup_title_jpof), 856, 164, 0, 0, 1, 0, this->width(), 0, this->height(), false)));
}
