...
GameObject::GameObject(GamePage *parent, initializer_list<QString> img_str, QPoint p, QPointF v, qreal omega, QRect border, attribute collision, attribute stubborn, attribute grativity, attribute cankill)
